...
-- AddForeignKey
ALTER TABLE "RequestItem" ADD CONSTRAINT "RequestItem_ingredient_id_fkey" FOREIGN KEY ("ingredient_id") REFERENCES "INGREDIENTS"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "RETURN_REQUESTS" ADD CONSTRAINT "RETURN_REQUESTS_request_id_fkey" FOREIGN KEY ("request_id") REFERENCES "RequestItem"("id") ON DELETE CASCADE ON UPDATE CASCADE;
